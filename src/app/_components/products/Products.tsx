...
export const Products = () => {
    return (
        <div className="bg-white">
            ...
            {/* searchbar  may actually be a part of Products page*/}
            <h2 className="text-2xl font-bold tracking-tight text-gray-900">All Products</h2>            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
